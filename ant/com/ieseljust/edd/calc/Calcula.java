...
public class Calcula {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("La multiplicació entre " + operand1 + " y " + operand2 + " es "
                + myCalc.multiplica(operand1, operand2));
        System.out.println(
                "La divisió entre " + operand1 + " y " + operand2 + " es " + myCalc.divideix(operand1, operand2));
        System.out.println(
                "Última operació realitzada: " + myCalc.getLastOp() + "; Últim resultat: " + myCalc.getLastResult());
    }
}
